---
title: 在 AiPMChat 中使用百川 API Key
description: 学习如何在 AiPMChat 中配置和使用百川的API Key，以便开始对话和交互。
tags:
  - LobeChat
  - 百川
  - 百川智能
...
至此你已经可以在 AiPMChat 中使用百川提供的模型进行对话了。
