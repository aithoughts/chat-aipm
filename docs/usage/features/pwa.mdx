---
title: AiPMChat support Progressive Web Apps (PWA)
description: >-
  Discover how AiPMChat utilizes Progressive Web App (PWA) technology to provide
  a seamless and near-native app experience on both desktop and mobile devices.
  Learn how to install AiPMChat as a desktop app for enhanced convenience.
tags:
  - Progressive Web App
  - PWA
  - AiPMChat
...
<Callout type={'tip'}>
  The default installed AiPMChat PWA icon has a black background, you can use <kbd>cmd</kbd> +  <kbd>i</kbd> to paste the following image to replace it with a white background.
</Callout>
...
<Image
  ...
  borderless
  cover
  src={'https://github.com/aipmhub/aipm-chat/assets/36695271/16ce82cb-49be-4d4d-ac86-4403a1536917'}
/>
