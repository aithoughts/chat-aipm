---
title: Using Google Gemma Model in AiPMChat
description: >-
  Learn how to integrate and utilize Google Gemma in AiPMChat, an open-source
  large language model, in AiPMChat with the help of Ollama. Follow these steps
...
<Image
  alt={'Using Gemma in AiPMChat'}
  cover
  src={'https://github.com/aipmhub/aipm-chat/assets/17870709/65d2dd2a-fdcf-4f3f-a6af-4ed5164a510d'}
/>

[Gemma](https://blog.google/technology/developers/gemma-open-models/) is an open-source large language model (LLM) from Google, designed to provide a more general and flexible model for various natural language processing tasks. Now, with the integration of AiPMChat and [Ollama](https://ollama.com/), you can easily use Google Gemma in AiPMChat.

This document will guide you on how to use Google Gemma in AiPMChat:
...
<Image
  ...
  height={473}
  inStep
  src={'https://github.com/aipmhub/aipm-chat/assets/28616219/7049a811-a08b-45d3-8491-970f579c2ebd'}
  width={791}
/>
...
<Image
  ...
  height={629}
  inStep
  src={'https://github.com/aipmhub/aipm-chat/assets/28616219/c91d0c18-a21f-41f6-b5cc-94d29faeb797'}
  width={791}
/>
...
Now, you can start conversing with the local Gemma model using AiPMChat.
