---
title: Using OpenRouter API Key in AiPMChat
description: >-
  Learn how to integrate and utilize OpenRouter's language model APIs in
  AiPMChat. Follow these steps to register, create an API key, recharge credit,
...
# Using OpenRouter in AiPMChat

<Image
  alt={'Using OpenRouter in AiPMChat'}
  cover
  src={'https://github.com/aipmhub/aipm-chat/assets/34400653/40520a43-ac03-4954-8a4d-282fbb946066'}
/>
...
This document will guide you on how to use OpenRouter in AiPMChat:
...
<Image
  ...
  height={457}
  inStep
  src={'https://github.com/aipmhub/aipm-chat/assets/34400653/a024af40-e1d9-4df0-b998-0e6e87cebe5b'}
/>
...
- Name your API key in the pop-up dialog, for example, "AiPMChat Key"
...
<Image
  ...
  height={460}
  inStep
  src={'https://github.com/aipmhub/aipm-chat/assets/34400653/094d701f-ce80-464a-bbbc-0a5ecc8d08e3'}
/>
...
<Image
  ...
  height={519}
  inStep
  src={'https://github.com/aipmhub/aipm-chat/assets/34400653/7a012a11-87bd-4366-a567-0ebf6d12ae10'}
/>
...
<Image
  ...
  height={385}
  inStep
  src={'https://github.com/aipmhub/aipm-chat/assets/34400653/50b73232-01fc-4ef0-939a-3e06354d1b5a'}
/>

### Step 4: Configure OpenRouter in AiPMChat

- Visit the `Settings` interface in AiPMChat
- Find the setting for `OpenRouter` under `Language Models`
- Enable OpenRouter and enter the API key you obtained

<Image
  alt={'Configure OpenRouter in AiPMChat'}
  height={518}
  inStep
  src={'https://github.com/aipmhub/aipm-chat/assets/34400653/5c3898ab-23d7-44c2-bbd9-b255e25e400c'}
/>
...
<Image
  ...
  height={518}
  inStep
  src={'https://github.com/aipmhub/aipm-chat/assets/34400653/77b5feee-3f46-486d-9a36-31ff60efa5e9'}
/>
...
You can now engage in conversations using the models provided by OpenRouter in AiPMChat.
