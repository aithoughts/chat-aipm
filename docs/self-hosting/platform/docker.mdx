---
title: Deploy AiPMChat with Docker
description: >-
  Learn how to deploy the AiPMChat service using Docker, including installation
...
We provide a [Docker image][docker-release-link] for you to deploy the AiPMChat service on your private device.
...
Use the following command to start the AiPMChat service with one click:
...
- For the complete list of environment variables supported by AiPMChat, please refer to the [Environment Variables](/docs/self-hosting/environment-variables) section.
...
<Callout type="warning">
  ...
  stolen!!!](https://github.com/aipmhub/aipm-chat/issues/1123).
</Callout>
