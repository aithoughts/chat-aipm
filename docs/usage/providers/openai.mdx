---
title: Using OpenAI API Key in AiPMChat
description: >-
  Learn how to integrate OpenAI API Key in AiPMChat. Support GPT-4o /
...
# Using OpenAI in AiPMChat

<Image
  alt={'Using OpenAI in AiPMChat'}
  cover
  src={'https://github.com/aipmhub/aipm-chat/assets/17870709/c9e5eafc-ca22-496b-a88d-cc0ae53bf720'}
/>

This document will guide you on how to use [OpenAI](https://openai.com/) in AiPMChat:
...
- Visit the `Settings` page in AiPMChat
- Find the setting for `OpenAI` under `Language Model`

<Image
  alt={'Enter API Key'}
  inStep
  src={'https://github.com/aipmhub/aipm-chat/assets/17870709/3f31bc33-509f-4ad2-ba81-280c2a6ec5fa'}
/>
...
<Image
  ...
  inStep
  src={'https://github.com/aipmhub/aipm-chat/assets/17870709/ff7ebacf-27f0-42d7-810b-00314499a084'}
/>
...
You can now engage in conversations using the models provided by OpenAI in AiPMChat.
