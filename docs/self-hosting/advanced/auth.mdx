---
title: AiPMChat Authentication Service Configuration
...
AiPMChat supports the configuration of external authentication services using Clerk or Next Auth for internal use within enterprises/organizations to centrally manage user authorization.
