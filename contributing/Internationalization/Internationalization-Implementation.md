...
In the AiPMChat project, internationalization-related files are organized as follows:
...
The internationalization core implementation logic of AiPMChat is as follows:
