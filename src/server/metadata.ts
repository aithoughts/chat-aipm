...
export class Meta {
  public generate({
    description = 'AiPMChat offers you the best ChatGPT, OLLaMA, Gemini, Claude WebUI user experience',
    title,
    ...
    const siteTitle = title.includes('AiPMChat') ? title : title + ' · AiPMChat';
    return {
