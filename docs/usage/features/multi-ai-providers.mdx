---
title: AiPMChat with Multi AI Providers
description: >-
  Discover how AiPMChat offers diverse model service provider support, including
...
<Image
  ...
  borderless
  cover
  src={'https://github.com/aipmhub/aipm-chat/assets/28616219/b164bc54-8ba2-4c1e-b2f2-f4d7f7e7a551'}
/>
...
To meet the specific needs of users, AiPMChat also supports the use of local models based on [Ollama](https://ollama.ai), allowing users to flexibly use their own or third-party models. For more details, see [Local Model Support](/docs/usage/features/local-llm).
