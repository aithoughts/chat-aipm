---
title: AiPMChat support Speech Synthesis and Recognition (TTS & STT)
description: >-
  Experience seamless Text-to-Speech (TTS) and Speech-to-Text (STT) technologies
  in AiPMChat. Choose from a variety of high-quality voices for personalized
  communication. Learn more about AiPMTTS toolkit @lobehub/tts.
tags:
  - AiPMChat
  - TTS
  - STT
...
<Image
  ...
  borderless
  src={'https://github.com/aipmhub/aipm-chat/assets/28616219/52d20fdc-48c0-45e4-9c51-ee150fc18be7'}
/>

[`@lobehub/tts`](https://tts.theforage.cn) is a high-quality TTS toolkit developed using the TS language, supporting usage in both server and browser environments.
...
<Callout type={'info'}>
  During the implementation of the TTS feature in AiPMChat, we found that there was no good frontend
