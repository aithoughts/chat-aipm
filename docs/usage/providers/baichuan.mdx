...
description: >-
  Learn how to integrate Baichuan AI into AiPMChat for enhanced conversational
...
You can now use the models provided by Baichuan for conversation in AiPMChat.
