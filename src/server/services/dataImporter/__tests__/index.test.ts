          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'AiPMChat is an AI conversation application built with the Next.js framework. I will help you write the development documentation for AiPMChat.',
                tags: [
                ...
                title: 'AiPMChat Technical Documentation Expert',
              },
              type: 'agent',
