---
title: Integrating Data Analytics Services in AiPMChat for User Usage Analysis
description: >-
  Learn how to integrate free/open-source data analytics services in AiPMChat to
...
To better help analyze the usage of AiPMChat users, we have integrated several free/open-source data analytics services in AiPMChat for collecting user usage data, which you can enable as needed.
