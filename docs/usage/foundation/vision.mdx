...
description: >-
  Explore how AiPMChat integrates visual recognition capabilities into large
...
The ecosystem of large language models that support visual recognition is becoming increasingly rich. Starting from `gpt-4-vision`, AiPMChat now supports various large language models with visual recognition capabilities, enabling AiPMChat to have multimodal interaction capabilities.
