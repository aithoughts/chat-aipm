  ...
  invokeBuiltinTool: async (id, payload) => {
    ...
    try {
      ...
      await internal_updatePluginError(id, {
        ...
        body: {
          message:
            "[plugin] fail to transform plugin arguments to ai state, it may due to model's limited tools calling capacity. You can refer to https://theforage.cn/docs/usage/tools-calling for more detail.",
          stack: err.stack,
          arguments: params,
          schema,
        },
