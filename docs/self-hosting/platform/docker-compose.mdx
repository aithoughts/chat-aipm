---
title: Deploy AiPMChat with Docker Compose
description: >-
  Learn how to deploy the AiPMChat service using Docker Compose. Follow
...
We provide a [Docker image][docker-release-link] for deploying the AiPMChat service on your private device.
...
Run the following command to start the AiPM Chat service:
...
Similarly, you can use the following script to automatically update AiPM Chat. When using `Docker Compose`, no additional configuration of environment variables is required.
